...
class New_Toplevel_1:
  def __init__(self, top=None):
    ...
    self.giorno.insert(END, "2016,1,28")
  ...
  def partite(self):
    try:
      ...
      if self.giorno.get() == '':
        ...
        partite = self.richiesta.richiesta_cinque(var2)
        str1 = ''
        for element in partite:
          str1 += element + '\n'
        print('\n\nPartite del ' + var2 + ':' + '\n\n' + str1)
    ...
    try:
      ...
      if self.giornata.get() == '':
        ...
        for element in list(self.richiesta.richiesta_sei(var1, var2)):
          str1 += element + '\n'
        print('\nLe ' + str(var2) + ' squadre con più goal fatti:  \n\n', str1)
  ...
  def min_goal(self):
    try:
      ...
      if self.giornata.get() == '':
        ...
        var2 = int(self.interok.get())
        str1 = ''
        for element in list(self.richiesta.richiesta_sette(var1, var2)):
          str1 += element + '\n'
        print('\nLe ' + str(var2) + ' squadre con meno goal subiti:  \n\n', str1)
    except KeyError:
  ...
  def diff_goal(self):
    try:
      ...
      if self.giornata.get() == '':
        ...
        var2 = int(self.interok.get())
        str1 = ''
        for element in list(self.richiesta.richiesta_otto(var1, var2)):
          str1 += element + '\n'
        print('\nLe ' + str(var2) + ' squadre con migliore differenza reti:  \n\n', str1)
    except KeyError:
